...
import { DeleteAuthEmployeePrivateDto, DeleteAuthEmployeeRoleDto, DeleteAuthStudentPrivateDto, DeleteAuthStudentRoleDto, DeleteModuleDto } from "src/microservice/dto/users/module.dto/module/delete-module.dto";
...
export class UsersModuleController {
    ...
    async deleteModule(@Param() deleteModuleDto :DeleteModuleDto) {
      return await this.moduleService.deleteModule(deleteModuleDto);
    }
    ...
    @Delete("/deleltEmployeeAuth/id=:authId")
    async moduleEmployeeAuthdelelt (@Param() deleteAuthDto: DeleteAuthEmployeeRoleDto) {
    ...
    @Delete("/deleltStudentAuth/id=:authId")
    async moduleStudentAuthdelelt (@Param() deleteAuthDto: DeleteAuthStudentRoleDto) {
